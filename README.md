...
| **octopus**  | Игровой сервис: гача осьминогов, инвентарь, экипировка, данжи, оркестрация боёв               |
| **fightService** | Пошаговый боевой движок на **.NET** (вне Maven-монорепо): ATB, ИИ мобов, формулы урона     |
